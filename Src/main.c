...
/* USER CODE BEGIN 0 */
int buttonFlag;
uint8_t tx_buff[sizeof(PREAMBLE)+NUM_BYTES];
...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
    ...
    enum {IDLE, PREDICTING, RECEIVING, ROTATING, PRINTING} state;
    state = IDLE;
    printIdle();
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_11|GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_6
  ...
  /*Configure GPIO pin : SHUTTER_Pin */
  ...
  /*Configure GPIO pins : PD11 PD4 PD5 PD6
                           PD7 */
